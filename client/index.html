	...
	<body>
		<div id='content'>
			...
			<form id='send-form'>
				...
				<input id='send-button' type='submit' value='Wyslij'/>
				<div id='help'>
					Polecenia czatu:
					<ul>
						<li>Zmiana nazwy uzytkownika: <code>/nick [nazwa uzytkownika]</code></li>
						<li>Przejscie do lub utworzenie pokoju: <code>/join [nazwa pokoju]</code></li>
					</ul>
				</div>
			</form>
		</div>
